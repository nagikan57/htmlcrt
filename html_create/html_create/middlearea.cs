...
namespace html_create
{
    class MiddleArea
    {
        ...
        public static string createOther(MiddleCsvModel rec)
        {
            string ret = "";
        ...
        public static List<MiddleCsvModel> read_low(string temp)
        {
    ...
    public class MiddleCsvModel
    {
        //情報 見出し,電話番号,住所,センター長,コメント,出張地域,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,近隣エリアで探す,,,,,

        public string no { get; set; }      //0
        public string larea { get; set; }   //1
        public string marea { get; set; }   //2
        public string url { get; set; }     //5
        public string title { get; set; }   //7
        public string desc { get; set; }    //8
        public string h1 { get; set; }      //9
        public string h1alt1 { get; set; }
        public string h1alt2 { get; set; }
        ...
        public string info_midasi { get; set; }
